...
public class Koparka {
    //pola  pozwalajace na obrót ramion
    public float kat1;
    public float kat2;
    public float kat3;
    public float kat4;
    ...
    //klasa do k¹tów
    public void ZmienKat1(float k){
        kat1 += k;
    }
    public void ZmienKat2(float k){
        kat2 += k;
    }
    public void ZmienKat3(float k){
        kat3 += k;
    }
    public void ZmienKat4(float k){
        kat4 -= k;
    }
    ...
    public void Rysuj(GL gl){
        ...
        gl.glRotatef(kat2,0.0f,1.0f,0.0f); //lewo prawo
        gl.glRotatef(45.0f+kat1,0.0f,0.0f,1.0f); // gory dole
